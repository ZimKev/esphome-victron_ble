...
CONF_ON_SMART_BMS_MESSAGE = "on_smart_bms_message"
...
VictronBleDataConstPtr = (
    victron_ble_ns.struct("VictronBleData").operator("ptr").operator("const")
)
MessageTrigger = victron_ble_ns.class_(
    "MessageTrigger", automation.Trigger.template(VictronBleDataConstPtr)
)

BatteryMonitorMessageConstPtr = (
    victron_ble_ns.struct("VICTRON_BLE_RECORD_BATTERY_MONITOR")
    .operator("ptr")
    .operator("const")
)
BatteryMonitorMessageTrigger = victron_ble_ns.class_(
    "BatteryMonitorMessageTrigger",
    automation.Trigger.template(BatteryMonitorMessageConstPtr),
)

SolarChargerMessageConstPtr = (
    victron_ble_ns.struct("VICTRON_BLE_RECORD_SOLAR_CHARGER")
    .operator("ptr")
    .operator("const")
)
SolarChargerMessageTrigger = victron_ble_ns.class_(
    "SolarChargerMessageTrigger",
    automation.Trigger.template(SolarChargerMessageConstPtr),
)

InverterMessageConstPtr = (
    victron_ble_ns.struct("VICTRON_BLE_RECORD_INVERTER")
    .operator("ptr")
    .operator("const")
)
InverterMessageTrigger = victron_ble_ns.class_(
    "InverterMessageTrigger", automation.Trigger.template(InverterMessageConstPtr)
)

DcDcConverterMessageConstPtr = (
    victron_ble_ns.struct("VICTRON_BLE_RECORD_DCDC_CONVERTER")
    .operator("ptr")
    .operator("const")
)
DcDcConverterMessageTrigger = victron_ble_ns.class_(
    "DcDcConverterMessageTrigger",
    automation.Trigger.template(DcDcConverterMessageConstPtr),
)

SmartLithiumMessageConstPtr = (
    victron_ble_ns.struct("VICTRON_BLE_RECORD_SMART_LITHIUM")
    .operator("ptr")
    .operator("const")
)
SmartLithiumMessageTrigger = victron_ble_ns.class_(
    "SmartLithiumMessageTrigger",
    automation.Trigger.template(SmartLithiumMessageConstPtr),
)

InverterRsMessageConstPtr = (
    victron_ble_ns.struct("VICTRON_BLE_RECORD_INVERTER_RS")
    .operator("ptr")
    .operator("const")
)
...
SmartBatteryProtectMessageConstPtr = (
    victron_ble_ns.struct("VICTRON_BLE_RECORD_SMART_BATTERY_PROTECT")
    .operator("ptr")
    .operator("const")
)
SmartBatteryProtectMessageTrigger = victron_ble_ns.class_(
...
LyncSmartBmsMessageConstPtr = (
    victron_ble_ns.struct("VICTRON_BLE_RECORD_LYNX_SMART_BMS")
    .operator("ptr")
    .operator("const")
)
LyncSmartBmsMessageTrigger = victron_ble_ns.class_(
    "LyncSmartBmsMessageTrigger",
    automation.Trigger.template(LyncSmartBmsMessageConstPtr),
)

MultiRsMessageConstPtr = (
    victron_ble_ns.struct("VICTRON_BLE_RECORD_MULTI_RS")
    .operator("ptr")
    .operator("const")
)
MultiRsMessageTrigger = victron_ble_ns.class_(
    "MultiRsMessageTrigger", automation.Trigger.template(MultiRsMessageConstPtr)
)

VeBusMessageConstPtr = (
    victron_ble_ns.struct("VICTRON_BLE_RECORD_VE_BUS").operator("ptr").operator("const")
)
VeBusMessageTrigger = victron_ble_ns.class_(
    "VeBusMessageTrigger", automation.Trigger.template(VeBusMessageConstPtr)
)

DcEnergyMeterMessageConstPtr = (
    victron_ble_ns.struct("VICTRON_BLE_RECORD_DC_ENERGY_METER")
    .operator("ptr")
    .operator("const")
)
